...
Module['FS_createPath']("/", "resources", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/font.ttf", "start": 0, "end": 133596}, {"filename": "/resources/points.txt", "start": 133596, "end": 133880}], "remote_package_size": 133880});

  })();

// end include: /tmp/tmp8pop2wqh.js
// include: /tmp/tmpl925egft.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpl925egft.js
// include: /tmp/tmp347mv8q9.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp347mv8q9.js
...
var ASM_CONSTS = {
  246926: () => { if (document.fullscreenElement) return 1; },  
 246972: () => { return Module.canvas.width; },  
 247004: () => { return parseInt(Module.canvas.style.width); },  
 247052: () => { document.exitFullscreen(); },  
 247079: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 247151: () => { if (document.fullscreenElement) return 1; },  
 247197: () => { return Module.canvas.width; },  
 247229: () => { return screen.width; },  
 247254: () => { document.exitFullscreen(); },  
 247281: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 247475: () => { return window.innerWidth; },  
 247501: () => { return window.innerHeight; },  
 247528: () => { if (document.fullscreenElement) return 1; },  
 247574: () => { return Module.canvas.width; },  
 247606: () => { return parseInt(Module.canvas.style.width); },  
 247654: () => { if (document.fullscreenElement) return 1; },  
 247700: () => { return Module.canvas.width; },  
 247732: () => { return screen.width; },  
 247757: () => { return window.innerWidth; },  
 247783: () => { return window.innerHeight; },  
 247810: () => { if (document.fullscreenElement) return 1; },  
 247856: () => { return Module.canvas.width; },  
 247888: () => { return screen.width; },  
 247913: () => { document.exitFullscreen(); },  
 247940: () => { if (document.fullscreenElement) return 1; },  
 247986: () => { return Module.canvas.width; },  
 248018: () => { return parseInt(Module.canvas.style.width); },  
 248066: () => { document.exitFullscreen(); },  
 248093: ($0) => { Module.canvas.style.opacity = $0; },  
 248131: () => { return screen.width; },  
 248156: () => { return screen.height; },  
 248182: () => { return window.screenX; },  
 248209: () => { return window.screenY; },  
 248236: () => { return window.devicePixelRatio; },  
 248272: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 248325: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 248376: () => { Module.canvas.style.cursor = 'none'; },  
 248413: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 248669: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 248720: () => { if (document.pointerLockElement) return 1; },  
 248767: () => { if (document.fullscreenElement) return 1; },  
 248813: () => { return window.innerWidth; },  
 248839: () => { return window.innerHeight; }
};
